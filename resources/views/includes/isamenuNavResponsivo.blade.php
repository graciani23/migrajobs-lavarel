...
<head>
    ...
    <link rel="stylesheet" href="./assets/css/isamenuNavResp.css">
...
<nav class="navbar navbar-expand-lg  navbar-dark bg-rgb(0, 59, 96)">
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
    ...
    <form class="linguas d-flex flex-column pr-5">
        <div class="idioma">
        <p style="margin-bottom:0rem">Selecione o seu idioma</p>
        </div>
        <div class="bandeiras pl-2">
